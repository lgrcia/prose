...
class NNCentroid(Block):
    ...
    @staticmethod
    def doc():
        return """A Convolutional Neural Network trained to locate the center of a star from a cutout image. Lead to an accurate and very fast method for centroiding (mean square error is 0.03 pixels)
